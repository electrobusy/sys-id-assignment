...
train_pct = 0.01; % percentage of training data to be used
...
%         clf;
%         num_fig = 1;
%         plot_RBF_inputs(Cm,num_fig,['RBF-NN - ' data_set ' -> For ' num2str(n) ' neurons'],Z_k_rec(:,[1 2]),net_aux.centers,input_train',input_val',input_test',Cm_train',Cm_val',Cm_test');          
%         axis([-0.2 0.6 -0.3 0.3]);
